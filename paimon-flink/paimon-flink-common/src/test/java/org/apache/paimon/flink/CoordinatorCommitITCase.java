...
public class CoordinatorCommitITCase {
    ...
    public void testEarlyTerminalWriterFinishesWhileOtherWriterRemainsRunning() throws Exception {
        ...
        try {
            // Subtask 0 reaches EndInput earlier; its writer must be released to FINISHED only
            // after the coordinator commits its ordinary data and sends the ACK. Subtask 1
            // deliberately remains active, so the job must stay RUNNING without any global
            // MAX finalization.
